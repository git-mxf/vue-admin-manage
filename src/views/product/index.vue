<template>
    <div class="app-container calendar-list-container">
        ...
        <el-table :data="list" border v-loading="listLoading">
            <el-table-column prop="category.name" label="分类" width="150"> </el-table-column>
...
<script>
    import { getList, updateProduct, destroyProduct } from 'api/product';
    ...
    export default{
        ...
        methods:{
            ...
            //编辑
            handleEdit(id) {
                this.$router.push({ path: '/product/' + id + '/edit' });
            },
            //删除
            handleDel(row) {
            ...
            handleModifyStatus(row, status) {
                updateProduct(row.id, {is_draft: status}).then(response => {
                    this.$message({
                        message: '操作成功',
                        type: 'success'
                    });
